...
export default function HeroSection() {
  const { allowContinuousMotion, allowInteractiveMotion } =
    useMotionPreference();
  ...
  }, [allowInteractiveMotion, mouseX, mouseY]);
    ...
    <section className="relative overflow-hidden bg-gradient-to-br pt-[50px] from-slate-950 via-blue-950 to-slate-900 min-h-screen">
      ...
      {allowInteractiveMotion &&
        floatingIcons.map(({ Icon, delay, x, y }, index) => {
          const offsets = floatingIconOffsets[index] ?? {
            x: 0,
            y: 0,
          };
          ...
          return (
            <motion.div
              ...
              style={{ left: x, top: y, x: offsets.x, y: offsets.y }}
        ...
        <div className="flex-1 space-y-8 text-center lg:text-left">
          ...
          >
            <motion.p
              ...
              animate={
                allowContinuousMotion ? { opacity: [0.6, 1, 0.6] } : undefined
              }
              transition={
                allowContinuousMotion
