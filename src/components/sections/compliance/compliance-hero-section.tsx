...
import { ArrowRight, CheckCircle2, Lock, ShieldCheck, ShieldAlert } from "lucide-react";
...
const stats = [
  { label: "Controls", value: "120+", helper: "Mapped to HIPAA & SOC" },
  { label: "Incidents", value: "0", helper: "Zero PHI breaches" },
  { label: "Audits", value: "Quarterly", helper: "Independent review" },
];
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 text-white">
      ...
      <div className="container relative grid gap-12 pt-[70px] pb-20 lg:grid-cols-[1.2fr,0.8fr] lg:items-center lg:pt-32 lg:pb-28">
        <div className="space-y-7">
          ...
          >
            The compliance rigor from our service pages now anchors your overview: enforced BAAs,
            principle-of-least-privilege access, and continuous monitoring that keeps every record
            auditable.
          </motion.p>
        ...
        >
          ...
          <div className="relative space-y-6">
            ...
            <div className="space-y-4 rounded-2xl border border-white/10 bg-white/5 p-6 shadow-sm">
              <p className="text-sm font-semibold text-blue-50">What to expect on every engagement</p>
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-white/5 p-4 text-white shadow-sm">
              ...
              <div>
                ...
                <p className="text-base font-semibold">Protected PHI handling</p>
              </div>
            </div>
          </div>
        </motion.div>
      ...
      {/* Wave divider to mirror detailed service pages */}
